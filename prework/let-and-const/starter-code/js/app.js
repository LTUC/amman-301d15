...
function displayPics() {
  ...
  // let declaration can be scoped to a code block while var declaration can be accessed from anywhere as long as its in the same scope in which the variable was declared
  console.log(viewed);
